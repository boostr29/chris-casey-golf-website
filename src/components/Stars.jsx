...
export function Stars({
    rating = 5,    // you can pass a different number of stars if you want
    name = "",     // the dynamic name to show
    review = "",
  })  {
  return (
    <div className="rounded-md py-6 px-8 font-roboto text-left mb-5 max-w-lg italic text-gray-600 bg-gray-100">
        ...
        <div className="flex flex-col items-end gap-2 mt-3">
            <div className="inline-flex items-center [&_data-slot=icon]:w-5 [&_data-slot=icon]:h-5 [&_data-slot=icon]:text-inherit [&_data-slot=icon]:cursor-pointer text-amber-400">
                <p className="font-sans antialiased text-base text-amber-400 font-semibold pr-3">{ rating }</p>
            ...
            <p className="font-header inline font-medium antialiased text-lg">
                {name}
            </p>
        </div>
    </div>
