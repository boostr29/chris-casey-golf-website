...
<div className="relative flex flex-col justify-between md:flex-row pt-1 md:pt-2 lg:pt-3 overflow-hidden z-10 bg-white
  ...
  <div className="relative z-10 w-full md:flex-1 flex flex-col justify-center">
    ...
    <RevealFrom
      triggerOnce={true}
      className="w-full flex flex-col justify-center mt-25 md:mt-30"
      initial={{ opacity: 0, y: -120 }}
      animateIn={{ opacity: 1, y: 0 }}
      threshold={0}
      rootMargin="0px 0px -20% 0px"
    >
      <div className="flex flex-col custom-px">
        <div className="flex flex-col justify-between m-auto pt-0"> 
          ...
          <h1 className="sr-only">Elevate Your Golf Game - Professional Golf Instruction in Lake Forest, CA</h1>
          
          {/* Visual heading for users */}
          <div className="animate-float font-header 
          text-[clamp(2.6rem,12vw,12.97rem)]
          leading-[0.9]
          text-gray-50 font-extrabold uppercase text-center z-3 opacity-90 
          2xl:mt-8
          xs:mt-5 
          2xs:mt-4 
          3xs:mt-2" aria-hidden="true">
            <span>E</span>
            <span>l</span>
            <span>e</span>
          ...
          <div className="flex self-center justify-center" aria-hidden="true">
      ...
      >
        <div className="flex flex-col pt-1">
          <div className="py-0 lg:py-2 md:py-5 px-2">
            <p className="font-roboto text-white/90 text-center md:text-left flex flex-col ">
              <span className="
              text-[1.15em]/6 
              2xl:text-[1.6em]/8 
              xl:text-[1.5em]/7 
              lg:text-[1.4em]/8 
              md:text-[1.3em]/6">Take your golf game to the next level with <strong>personalized golf lessons</strong> and <strong>proven techniques</strong> in <strong>Lake Forest, CA</strong>.</span>
            </p>
          </div>
          <div className="flex flex-row justify-center md:justify-start mt-8 mb-8 z-12">
            <a href="#contact" className="main-button" aria-label="Book a golf lesson with Chris Casey in Lake Forest CA">
              Book a Lesson Now! 
            </a>
          </div>
        </div>
      ...
      >
        <div className="flex justify-center">
          <ParallaxContainer
            ...
            className=""
          >
            <div className="flex self-end align-bottom justify-start overflow-visible
            w-full 
            2xl:min-w-[700px] 
            xl:min-w-[600px] 
            lg:min-w-[530px] 
            ...
            ml-0">
              <img 
                src="/images/chris-casey-2.png" 
                loading="lazy" 
                alt="Chris Casey professional golf instructor demonstrating golf swing technique in Lake Forest California" 
                className="mb-[-19px] opacity-95"
              />
            </div>
          </ParallaxContainer>
        </div>
